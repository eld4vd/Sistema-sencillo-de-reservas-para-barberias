            ...
            >
              ...
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-black/80 backdrop-blur-sm">
                  <service.icon className="text-2xl text-[#B8935E]" />
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <Link
                  to="/reservas"
                  className={`block w-full rounded-xl py-3 text-center text-sm font-semibold uppercase tracking-wider transition-all duration-300 ${
                    service.popular
