...
// rendering-hoist-jsx: función pura fuera del componente
...
// Sub-componente para cada item del masonry — useTransform se llama a nivel de componente (Rules of Hooks)
const MasonryItem = ({
  item,
  index,
  isHovered,
